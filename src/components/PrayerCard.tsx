...
export default function PrayerCard({ name, time, isNext }: PrayerCardProps) {
  return (
    <div
      className={`rounded-2xl p-4 transition-all flex flex-col justify-center items-center ${
        isNext
    ...
    >
      ...
      {isNext && (
        <div className="mt-2 text-center">
          <span className="inline-block bg-white text-green-700 px-3 py-1 rounded-full text-base font-bold animate-pulse">
            الصلاة القادمة
          </span>
        </div>
      )}
